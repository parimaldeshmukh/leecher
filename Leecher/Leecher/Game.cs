...
namespace Leecher
{
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            collidableObjects.Add(new StaticObject(Content.Load<Texture2D>(@"exit"), screenWidth - 90, screenHeight - 80, 50, 60));
            collidableObjects.Add(new StaticObject(Content.Load<Texture2D>(@"tree"), screenWidth - 320, screenHeight - 400, 200, 380));
            collidableObjects.Add(new StaticObject(Content.Load<Texture2D>(@"branch"), screenWidth - 370, screenHeight - 320, 50, 60));
            collidableObjects.Add(new StaticObject(Content.Load<Texture2D>(@"ladder"), screenWidth / 2, screenHeight - 600, 40, 200));
